...
单号解读：
B50000588736（B开头代表入云）
WJ0828004（WJ代表网建单，云内进行转发）
   """
    print(dline_cmd) 
...
# 通过本端互联地址找到vpn-instance
<BJYZB-B214-8_A4_8_B5-ASW-HCE68-1U41>display ip interface brief | include 10.101.80.181
