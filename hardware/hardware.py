...
....................................................	    ...............................   ...............................
.            Central Processing Unit               .        .         Processor Core      .   .         Processor Core      .
.                                                  .        ...............................   ...............................
.   .................          .................   .               |              |          	    |               |
.   .               .          .               .   .        ............... ...............   ............... ...............
.   .      ALU      .          .       CU      .   .        .     L1      . .     L1      .   .     L1      . .	    L1      .
.   .  Arithmetic   .          .    Control    .   .        . Instruction . .    Data     .   . Instruction . .    Data     .
.   .  Logic Unit   .          .      Unit     .   .        .    Cache    . .    Cache    .   .    Cache    . .    Cache    .
.   .               .          .               .   .        ............... ...............   ............... ...............
.   .................          .................   .        	    |              |          	    |               |
.                                                  .        ...............................   ...............................
.   ............................................   .        .           L2 Cache          .   .           L2 Cache          .
...
此外CPU内部还有单独的:
	FPU（浮点运算单元，Floating Point Unit）:执行浮点数的运算。
	SIMD 单元（如 SSE、AVX）:并行处理向量数据，加速多媒体和科学计算。
...
缓存（Cache）:L1、L2、L3缓存，包含提前加载可能会用到的数据的预取单元（Prefetch Unit）
时钟（Clock）:同步CPU所有操作的时序信号，以GHz为单位
总线接口单元（Bus Interface Unit, BIU）:负责与内存、I/O等外部设备通信（地址、控制、数据总线）。
加载/存储单元（Load/Store Unit）:处理指令与内存之间的数据交换。
分支预测器（Branch Predictor）:提高流水线效率，预测程序执行路径，减少控制冒险。
内存管理单元（MMU）:负责虚拟地址到物理地址的转换，并支持内存保护
	包括 TLB（Translation Lookaside Buffer）:加速地址转换。
系统单元（Uncore/System Agent）:
    包括内存控制器（Memory Controller）
    PCIe 控制器
    电源管理
    睡眠状态控制等

############################### caution ####################################
1、各个单元和 L1 Cache 之间，还有专用的高速临时存储电路。
