...
def main():
    ...
    if args.show == 'udp':
       ...
       print_rootdir_cmd()
    elif args.show == 'linux_route':
       print_linux_route_cmd()
    elif args.show == 'sec_enh':
       print_sec_enh_cmd()
    elif args.show == 'net_name':
       print_net_name_cmd()
    elif args.show == 'rsyslog_conf':
       print_rsyslog_conf_cmd()
    elif args.show == 'rsyslogd':
       print_rsyslogd_cmd()
    elif args.show == 'rsyslog_server':
       print_rsyslog_server_cmd()
    elif args.show == 'rsyslog_mysql':
       print_rsyslog_mysql_cmd()
    elif args.show == 'rsyslog_web':
       print_rsyslog_web_cmd()
    elif args.show == 'mysql_secure_installation':
       print_mysql_secure_installation_cmd()
    elif args.show == 'journalctl':
       print_journalctl_cmd()
    elif args.show == 'logger':
       print_logger_cmd()
    elif args.show == 'logrotate':
       print_logrotate_cmd()
    elif args.show == 'auditd':
       print_auditd_cmd()
    elif args.show == 'pam':
       print_pam_cmd()
    elif args.show == 'hosts_allow':
       print_hosts_allow_cmd()
    elif args.show == 'gs':
       print_gs_cmd()
    elif args.show == 'jobs':
       print_jobs_cmd()
       ...
       print_k8s_cmd()
    elif args.show == 'kubectl':
       print_kubectl_cmd()
    elif args.show == 'threads':
       print_threads_cmd()
    elif args.show == 'ovs':
       print_ovs_cmd()
    elif args.show == 'nslookup':
       print_nslookup_cmd()
    elif args.show == 'haproxy':
       print_haproxy_cmd()
    elif args.show == 'docker_run':
       ...
       print_curl_cmd()
    elif args.show == 'gotty':
       print_gotty_cmd()
    elif args.show == 'alias':
       print_alias_cmd()
    elif args.show == 'pstree':
       print_pstree_cmd()
    elif args.show == 'fs':
       print_fs_cmd()
    elif args.show == 'ns':
       print_ns_cmd()
    elif args.show == 'docker_repo':
       print_docker_repo_cmd()
    elif args.show == 'docker_theory':
       print_docker_theory_cmd()
    elif args.show == 'cgroup':
       print_cgroup_cmd()
    elif args.show == 'cgroup_ns':
       print_cgroup_ns_cmd()
    elif args.show == 'dockerdir':
       print_dockerdir_cmd()
    elif args.show == 'docker_img_create':
       print_docker_img_create_cmd()
    elif args.show == 'rootfs':
       print_rootfs_cmd()
    elif args.show == 'groupinstall':
       print_groupinstall_cmd()
    elif args.show == 'ldd':
       print_ldd_cmd()
    elif args.show == 'xargs':
       print_xargs_cmd()
    elif args.show == 'chroot':
       print_chroot_cmd()
    elif args.show == 'procfs':
       print_procfs_cmd()
    elif args.show == 'sysfs':
       print_sysfs_cmd()
    elif args.show == 'tmpfs':
       print_tmpfs_cmd()
    elif args.show == 'cgroupfs':
       print_cgroupfs_cmd()
    elif args.show == 'systemd_cgroup':
       print_systemd_cgroup_cmd()
    elif args.show == 'qemu_img':
       print_qemu_img_cmd()
    elif args.show == 'qcow2':
       print_qcow2_cmd()
    elif args.show == 'ssh':
       print_ssh_cmd()
    elif args.show == 'numa':
       print_numa_cmd()
    elif args.show == 'gpucmd':
       print_gpucmd_cmd()
    elif args.show == 'gem':
       print_gem_cmd()
    elif args.show == 'ipmitool':
       print_ipmitool_cmd()
    elif args.show == 'nethogs':
       print_nethogs_cmd()
    elif args.show == 'xxxx':
       print_xxxx_cmd()
